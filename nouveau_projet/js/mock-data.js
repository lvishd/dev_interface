...
const MOCK_TUNNELS = [
    {
        ...
        blocks: [
            ...
            { id: 'message_info', label: 'Message bloc INFO', type: 'information' },
        ...
        transitions: [
            ...
            { source: 'documents', target: 'message_info', condition: '', order: 4 },
            { source: 'message_info', target: 'paiement', condition: '', order: 5 },
            { source: 'paiement', target: 'FIN', condition: '', order: 6 },
        ],
    },
    {
        id: 'DGE',
