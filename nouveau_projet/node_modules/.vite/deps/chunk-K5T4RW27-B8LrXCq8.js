...
import { a as flatten, d as min, h as map, l as flatMap, m as filter, n as forEach, o as uniqBy, t as reduce } from "./reduce-s_8nKtbk.js";
...
var RecognizerEngine = class {
	initRecognizerEngine(tokenVocabulary, config) {
		...
		if (Array.isArray(tokenVocabulary)) this.tokensMap = tokenVocabulary.reduce((acc, tokType) => {
			...
			this.tokensMap = [...new Set(allTokenTypes)].reduce((acc, tokType) => {
				acc[tokType.name] = tokType;
				return acc;
			}, {});
		...
		this.tokenMatcher = (Object.hasOwn(tokenVocabulary, "modes") ? Object.values(tokenVocabulary.modes).flat() : Object.values(tokenVocabulary)).every((tokenConstructor) => {
			var _a;
...
//# sourceMappingURL=chunk-K5T4RW27-B8LrXCq8.js.map